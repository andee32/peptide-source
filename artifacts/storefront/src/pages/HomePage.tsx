...
/**
 * Homepage — "the document is the pitch".
 *
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="font-display text-4xl md:text-5xl font-extrabold tracking-tight mb-6">
              Every vial ships
              <br />
              <span className="text-primary">with its batch record.</span>
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed mb-4 max-w-xl">
              Peptides for laboratory research, filled and labelled to lot. Look
              up any lot number and read the certificate before you buy.
            </p>
            <p className="text-sm text-muted-foreground mb-8">
              Research use only &mdash; not for human or animal consumption.
            </p>
